...
describe SlackGamebot::Commands::Promote do
  ...
  it 'gives help' do
    expect(message: '<@bot_user_id> promote', user: user.user_id, channel: channel).to respond_with_slack_message(
  ...
  it 'promotes another user' do
    ...
    expect(message: "<@bot_user_id> promote #{another_user.user_name}", user: user.user_id, channel: channel).to respond_with_slack_message(
  ...
  it 'cannot promote self' do
    expect(message: '<@bot_user_id> promote username', user: user.user_id, channel: channel).to respond_with_slack_message(
  ...
  it 'promotes multiple users' do
    ...
    expect(message: "<@bot_user_id> promote #{another_user1.user_name} #{another_user2.user_name} #{another_user3.user_name}", user: user.user_id, channel: channel).to respond_with_slack_message(
