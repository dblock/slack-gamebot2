...
describe SlackGamebot::Commands::Register, vcr: { cassette_name: 'user_info' } do
  ...
  it 'registers a new user and promotes them to captain' do
    ...
    expect do
      expect(message: '@gamebot register', user: 'user').to respond_with_slack_message("Welcome <@user>! You're ready to play. You're also team captain.")
  ...
  it 'renames an existing user' do
    ...
    expect do
      expect(message: '@gamebot register', user: 'user').to respond_with_slack_message("Welcome back <@user>, I've updated your registration. You're also team captain.")
  ...
  it 'already registered' do
    ...
    expect do
      expect(message: '@gamebot register', user: 'user').to respond_with_slack_message("Welcome back <@user>, you're already registered. You're also team captain.")
    end.not_to change(User, :count)
  end
