  ...
  shared_examples_for 'subscription' do
    context 'on trial' do
      ...
      it 'displays subscribe message' do
        expect(message: '@gamebot subscription').to respond_with_slack_message team.trial_message
      end
    end
    ...
    context 'with subscribed_at' do
      it 'displays subscription info' do
        ...
        expect(message: '@gamebot subscription').to respond_with_slack_message customer_info
      end
    end
